...
(function ($) {
    ...
    $.fn.fileinputLocales['fr'] = {
        ...
        msgFilesTooLess: 'Vous devez sélectionner au moins <b>{n}</b> {files} Ã  transmetter. Merci de recommencer !',
        ...
        msgFileSecured: "Des restrictions de sécurité vous empÃªchent d'accéder au fichier \"{name}\".",
